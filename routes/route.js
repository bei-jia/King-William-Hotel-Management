...
router.post("/reservation/cancel-reservation/:id", cancelReservation);
router.get("/reservation/edit-reservation/:id", editReservationView);
router.post("/reservation/edit-reservation/:id", editReservation);
